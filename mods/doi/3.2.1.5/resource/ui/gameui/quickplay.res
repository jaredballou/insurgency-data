"Resource/UI/GameUI/quickplay.res"
{
	...
	{	
		...
		SelectDifficultyNormal
		{
			...
			LblDifficultyNormalFullDescriptionTitle
			{	
				ControlName				Label	
				xpos					20
				ypos					138
				...
				fgColor_override 		"50 50 30 255"
				noMouseInput			1
				labelText 				"#GameUI_CooperativeDifficulty_Normal_FullDesc_Title"
				allcaps					1
			}

			LblDifficultyNormalFullDescriptionBody
			{	
				ControlName				Label	
				xpos					20
				ypos					160
				...
				fgColor_override 		"50 50 30 255"
				noMouseInput			1
				labelText 				"#GameUI_CooperativeDifficulty_Normal_FullDesc_Body"
		...
		SelectDifficultyHard
		{
			...
			LblDifficultyHardFullDescriptionTitle
			{	
				ControlName				Label	
				xpos					20
				ypos					138
				...
				fgColor_override 		"50 50 30 255"
				noMouseInput			1
				labelText 				"#GameUI_CooperativeDifficulty_Hard_FullDesc_Title"
				allcaps					1
			}

			LblDifficultyHardFullDescriptionBody
			{	
				ControlName				Label	
				xpos					20
				ypos					160
				...
				fgColor_override 		"50 50 30 255"
				noMouseInput			1
				labelText 				"#GameUI_CooperativeDifficulty_Hard_FullDesc_Body"
				auto_tall_tocontents	0
			}
