	...
	{	
		...
		{	
			...
			"DrpSuperBloom"
			{
				...
				"paintbackground"		"1"
				"bgcolor_override"		"255 255 255 255"
				"labelText"				"#GameUI_VideoOptions_SuperBloom"
				"style"					"DialogListButton"
				"navUp"					"DrpSoftParticles"
				"navDown"				"DrpFlamethrowerLighting"
				"list"
				{
					"#GameUI_Enable"	"SuperBloomEnabled"
					"#GameUI_Disable"	"SuperBloomDisabled"
				}
			}

			"DrpFlamethrowerLighting"
			{
				"ControlName"			"HybridButton"
				"fieldName"				"DrpFlamethrowerLighting"
				"xpos"					"0"
				"ypos"					"221"
				"wide"					"462"	
				...
				"paintbackground"		"1"
				"bgcolor_override"		"255 255 255 255"
				"labelText"				"#GameUI_VideoOptions_FlamethrowerLighting"
				"style"					"DialogListButton"
				"navUp"					"DrpSuperBloom"
				"list"
				{
					"#GameUI_Enable"	"FlamethrowerLightingEnabled"
					"#GameUI_Disable"	"FlamethrowerLightingDisabled"
				}
			}
		}				
