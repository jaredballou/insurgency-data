...
Scheme
{
	...
	Colors
	{
		...
		// DOI colours
		"DoiMainMenuWhite"			"242 238 226 255"
		"DoiMainMenuWhiteDisabled"	"242 238 226 100"
		"DoiMainMenuButtonHover"	"39 26 20 255"
		"DoiMainMenuPanel"			"80 76 67 255"
		"DoiBlack"					"36 26 20 255"
		"DoiDullGrey"				"109 107 101 255"
		"DoiTransparent"			"0 0 0 0"
	...
	// Custom styles for use with HybridButtons
		...
		MenuHeaderButton.TextColor					InsWhite25
		MenuHeaderButton.TextColor_Armed			InsWhite75
		MenuHeaderButton.TextColor_Pressed			InsWhite75
		...
		MainMenuButton.Font							HeaderLarge
